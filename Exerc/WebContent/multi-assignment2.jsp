...
<body>
  ...
  document.getElementById("multtype").value = 2;
  document.getElementById("skillneed").value = "Construction worker";
  document.getElementById("skillneed1").value = "Plumber";
  document.getElementById("skillneed2").value = "Electrician";
			        </script>  
			        <div class="row">
    <div class="col-25">
  ...
  <div class="row">
    <div class="col-25">
     ...
     <h1><a style="text-align: left;font-size:25px;">Plumber</a></h1>
  </div>
  <div class="row">
    <div class="col-25">
      <label for="fname">Payment</label>
