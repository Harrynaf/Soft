...
<body>
  ...
  <div class="row">
    ...
    <h1><a style="text-align: left;font-size:25px;">Construction workers</a></h1>
  </div>
  <div class="row">
    <div class="col-25">
  ...
  <div class="row">
    <div class="col-25">
     ...
     <h1><a style="text-align: left;font-size:25px;">Plumbers</a></h1>
  </div>
  <div class="row">
    <div class="col-25">
      <label for="fname">Payment</label>
    ...
    <div class="col-25">
     ...
     <h1><a style="text-align: left;font-size:25px;">Electricians</a></h1>
  </div>
  <div class="row">
    <div class="col-25">
      <label for="fname">Payment</label>
